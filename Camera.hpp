...
public:
    ...
    Camera(vector3<double> eye_place, vector3<double> forward_direction, vector3<double> upward_direction, unsigned int picture_size_x = 400, unsigned int picture_size_y = 300, double input_angle_h = 105)
    {
        position = eye_place;

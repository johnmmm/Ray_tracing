...
public:
    ...
    Camera(vector3<double> eye_place, vector3<double> forward_direction, vector3<double> upward_direction, unsigned int picture_size_x = 960, unsigned int picture_size_y = 1280, double input_angle_h =95)
    {
        position = eye_place;
